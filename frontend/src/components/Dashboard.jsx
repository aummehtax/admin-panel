...
<div className="data-panel select-none text-white w-[86.4%] max-h-[92.6vh] min-h-[92.6vh] absolute right-1  top-16 overflow-y-scroll p-3">
        ...
        <div className="flex gap-4">
            ...
            <h1 className="text-3xl tracking-tight text-zinc-100">1,234</h1>
        </div>
        ...
        <div className="box border w-[20%] p-2 rounded-md flex flex-col gap-5">
            ...
            <h1 className="text-3xl tracking-tight text-zinc-100">14</h1>
        </div>
        </div>
        ...
        <div className="search-and-select mt-10 flex gap-4">
          ...
          <div>
            <div className="relative">
                    <input type="text"className="border w-90 h-9 rounded-md p-2 ps-8 outline-0" placeholder="Search users..." />
        ...
        <div className="data-view w-full h-auto border border-b-0 rounded-md mt-7 "> 
          ...
          <div className="w-full h-auto  flex flex-col">
            ...
            <div className="flex justify-between  border-b p-3 hover:bg-[#9492df8f] rounded-b-md">
                <div className="w-[150px]">aum mehta</div>
                <div className="w-[250px]">maum5302@gmail.com</div>
                <div className="w-[120px]">admin</div>
                <div className="w-[150px]">24/11/25</div>
