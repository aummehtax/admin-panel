...
import { changePassword, currentUser, dashboardData, deleteUser, editUser, loginUser, logoutUser, profile, profileUpdate, registerUser } from "../controllers/user.controllers.js";
...
router.route("/profile").get(verifyJWT, verifyRole("admin" , "moderator"), profile)
router.route("/profile/update").post(verifyJWT, verifyRole("admin" , "moderator"), profileUpdate)
router.route("/profile/changepassword").post(verifyJWT, verifyRole("admin" , "moderator"), changePassword)
